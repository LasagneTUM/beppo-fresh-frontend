    ...
    <div>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.ingredients}>
          <h2>Zutaten</h2>
          <ul>
            <Ingredient onFeedback={setToast} imageLink={exampleIngredient} amount='200 g' additionalInfo='Enthält Weizen'>Weizentortilla</Ingredient>
            <Ingredient onFeedback={setToast} imageLink={exampleIngredient} amount='175 g' additionalInfo='geräucherter Tofu'>Weizentortilla</Ingredient>
            <Ingredient onFeedback={setToast} imageLink={exampleIngredient} amount='1 piece'>Mango</Ingredient>
            <Ingredient onFeedback={setToast} imageLink={exampleIngredient} amount='2 piece'>rote Spitzpaprika</Ingredient>
          </ul>
          <hr />
